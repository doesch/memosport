function IctViewModel()
{
    ...
    */
    ...
    self.Init = function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var lId = jsLib.Cookie.Read("selected-icb");
                if(lId != null)
                {
                    // find in list
    ...
    self.BoxSelected = function(pIndexCardBox) {
        ...
        jsLib.Cookie.Write("selected-icb", pIndexCardBox.id, 365);
    };
...
var GlobalIctViewModel;

$(document).ready(function() {

    GlobalIctViewModel = new IctViewModel();

    ko.applyBindings(GlobalIctViewModel);
    
    // Start
    GlobalIctViewModel.Init();
    // GlobalIctViewModel.loadData();
